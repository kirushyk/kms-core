...
KMSCOREPLUGINS_OBJS=$(KMSCOREPLUGINS_SRC:.cpp=.o)

all: $(TARGET_DIR)/$(SDPAGENT_TARGET) $(TARGET_DIR)/$(KMSCOMMONS_TARGET) $(TARGET_DIR)/$(KMSCOREIMPL_TARGET) $(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET)
...
$(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET): $(KMSCOREPLUGINS_OBJS)
	mkdir -p $(TARGET_DIR)
	$(CXX) -shared -o $(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET) $(CFLAGS) $(KMSCOREPLUGINS_OBJS) $(KMSCOREPLUGINS_LIBS) -Wl,--out-implib,$(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET).a
...
clean:
	...
	rm $(TARGET_DIR)/$(KMSCOMMONS_TARGET)
	rm $(TARGET_DIR)/$(KMSCOMMONS_TARGET).a
	rm $(TARGET_DIR)/$(KMSCOREIMPL_TARGET)
	rm $(TARGET_DIR)/$(KMSCOREIMPL_TARGET).a
	rm $(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET)
	rm $(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET).a
