...
all: $(TARGET_DIR)/$(SDPAGENT_TARGET) $(TARGET_DIR)/$(KMSCOMMONS_TARGET) $(TARGET_DIR)/$(KMSCOREMODULE_TARGET) $(TARGET_DIR)/$(KMSCOREIMPL_TARGET) $(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET) $(TARGET_DIR)/$(VP8PARSE_TARGET)
