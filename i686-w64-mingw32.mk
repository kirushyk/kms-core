...
VP8PARSE_OBJS=$(VP8PARSE_SRC:.c=.o)
...
$(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET): $(KMSCOREPLUGINS_OBJS)
	mkdir -p $(TARGET_DIR)
	$(CC) -shared -o $(TARGET_DIR)/$(KMSCOREPLUGINS_TARGET) $(CFLAGS) $(KMSCOREPLUGINS_OBJS) $(KMSCOREPLUGINS_LIBS)

$(TARGET_DIR)/$(VP8PARSE_TARGET): $(VP8PARSE_OBJS)
	mkdir -p $(TARGET_DIR)
	$(CC) -shared -o $(TARGET_DIR)/$(VP8PARSE_TARGET) $(CFLAGS) $(VP8PARSE_OBJS) $(VP8PARSE_LIBS)
